package com.capitole.challenge.starwars.infrastructure.api.exception;

import com.capitole.challenge.starwars.api.lib.model.ErrorDto;
import com.capitole.challenge.starwars.application.error.CommonErrorMessage;
import com.capitole.challenge.starwars.application.exception.EntityNotFoundException;
import static com.capitole.challenge.starwars.infrastructure.api.exception.GlobalExceptionHandler.MS_STARWARS;
...
class GlobalExceptionHandlerTest {
  ...
  void givenException_whenMethodArgumentNotValid_thenReturnsErrorDto()
    ...
    Assertions.assertEquals(CommonErrorMessage.ARGUMENT_NOT_VALID.getCode(), errorDto.getCode());
    Assertions.assertEquals(
        "Validation failed for argument [0] in public void com.capitole.challenge.starwars.infrastructure.api.exception.GlobalExceptionHandlerTest.exampleMethod(java.lang.String): [Error in object 'name': codes []; arguments []; default message [Name cannot be empty]] ",
        errorDto.getMessage());
    Assertions.assertEquals(MS_STARWARS, errorDto.getSource());
  }
